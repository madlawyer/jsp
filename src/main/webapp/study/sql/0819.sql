...
insert into test4 values (default, '전자레인지', 800, 'JJ001');
...
-- springgroup데이터베이스의 student테이블의 foreign key를 삭제?
ALTER TABLE student DROP FOREIGN KEY student_ibfk_1;

/* -----활용(조인:JOIN) 설정---------------------------- */

-- 일반조인 = Inner Join = 내부조인 = 교집합
...
-- MySQL에서는 union을 이용하여 합집합의 개념으로 사용한다. - Merage(병합)
